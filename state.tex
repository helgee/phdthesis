...
The evolution of the system state within each phase is described by the \emph{equations of motions}, which will be discussed in detail in section~\ref{sec:equations-of-motion}.
