\begin{figure}[ht]
    ...
    \begin{tikzpicture}
        \begin{umlpackage}{CelestialBodies}
            ...
            \umlsimpleclass[x=-4, y=0]{Sun}
            \umlsimpleclass[x=-4, y=2]{MinorBody}
            \umlsimpleclass[x=0, y=4]{Planet}
            \umlsimpleclass[x=-4, y=4]{Satellite}
            ...
            \umlsimpleclass[x=-4, y=-4]{RightAscension}
            \umlsimpleclass[x=-4, y=-5]{Declination}
            \umlsimpleclass[x=-4, y=-6]{Rotation}

            \umlclass[type=interface, x=4, y=-5]{Ephemeris}{}{%
                position(date) \\
                velocity(date) \\
            }
            \umlimport[geometry=-|]{CelestialBody}{Ephemeris}
